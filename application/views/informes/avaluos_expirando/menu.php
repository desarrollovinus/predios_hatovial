<ul>
	<li><a href="<?php echo site_url('informes_controller'); ?>" >Actas</a></li>
	...
	<li class="current"><a href="<?php echo site_url('informes_controller/avaluos_en_vencimiento'); ?>">Aval&uacute;os por vencerse</a></li>
	<li><a href="<?php echo site_url('informes_controller/bitacora'); ?>">Bitácora</a></li>
	<li><a href="<?php echo site_url('informes_controller/gestion_predial'); ?>" target="_blank">Gesti&oacute;n Predial</a></li>
